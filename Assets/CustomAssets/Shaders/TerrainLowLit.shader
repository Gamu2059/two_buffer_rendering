Shader "Universal Render Pipeline/Custom/Terrain/LowLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "ForwardLitLowDpi"
            Tags{ "LightMode" = "UniversalForwardLowDpi" }
            HLSLPROGRAM
            #pragma target 3.0
        ...
        Pass
        {
            Name "DepthOnlyLowDpi"
            Tags{"LightMode" = "DepthOnlyLowDpi"}
