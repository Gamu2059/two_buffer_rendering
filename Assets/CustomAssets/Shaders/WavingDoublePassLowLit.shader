Shader "Hidden/TerrainEngine/Details/UniversalPipeline/WavingDoublePassLowLitbark"
{
    Properties
    {
    ...
    Dependency "OptimizedShader" = "Hidden/TerrainEngine/Details/UniversalPipeline/WavingDoublePass"
}
